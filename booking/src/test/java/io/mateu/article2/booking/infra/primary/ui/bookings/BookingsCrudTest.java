...
class BookingsCrudTest {
    ...
    public void allBookingsAreFound() throws Throwable {
        ...
        // when
        var page = bookingsCrud.fetchRows("", new BookingFilters(), Pageable.ofSize(30)).block();
    ...
    private void createBooking(String customerName, String serviceDescription) throws Throwable {
        var bookingCreationForm = (BookingCreationForm) bookingsCrud.getNewRecordForm();
    ...
    public void onlyBookingIsFound() throws Throwable {
        ...
        // when
        var page = bookingsCrud.fetchRows("mateu", new BookingFilters(), Pageable.ofSize(30)).block();
