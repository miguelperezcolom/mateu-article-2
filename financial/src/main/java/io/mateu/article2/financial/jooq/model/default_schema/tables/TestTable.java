...
public class TestTable extends TableImpl<TestTableRecord> {
    ...
    /**
     * The reference instance of <code>TEST_TABLE</code>
     */
    ...
    /**
     * The column <code>TEST_TABLE.TEST_COLUMN</code>.
     */
    public final TableField<TestTableRecord, Integer> TEST_COLUMN = createField(DSL.name("TEST_COLUMN"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>TEST_TABLE</code> table reference
     */
    ...
    /**
     * Create a <code>TEST_TABLE</code> table reference
     */
    public TestTable() {
